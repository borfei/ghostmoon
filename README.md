...
```ruby
gem "jekyll-theme-ghostmoon"
```

And add this line to your Jekyll site's `_config.yml`:

```yaml
theme: jekyll-theme-ghostmoon
```
...
To add a custom directory to your theme-gem, please edit the regexp in `jekyll-theme-ghostmoon.gemspec` accordingly.
